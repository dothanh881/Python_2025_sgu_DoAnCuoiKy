...
# Training parameters
start_epoch = 0
epochs = 20  # number of epochs to train for (if early stopping is not triggered) - tăng lên để train thêm
...
def validate(val_loader, encoder, decoder, criterion):
    ...
    with torch.no_grad():
        ...
        for i, (imgs, caps, caplens, allcaps) in enumerate(val_loader):
            ...
            # References
            allcaps = allcaps[sort_ind.cpu()]  # because images were sorted in the decoder # because images were sorted in the decoder
