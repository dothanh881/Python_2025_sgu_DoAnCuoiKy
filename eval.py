...
word_map_file = '/content/drive/MyDrive/Image_captioning_flickr8k/dataset/flickr8k_processed/WORDMAP_flickr8k_5_cap_per_img_5_min_word_freq.json'  # word map, ensure it's the same the data was encoded with and the model was trained with
